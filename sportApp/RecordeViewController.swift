...
struct Preference {
    ...
    var uri:String? = "rtmp://153.126.157.154/live/test"
...
class RecordeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        videoBitrateSlider.addTarget(self, action: Selector("onSliderValueChanged:"), forControlEvents: .ValueChanged)
        audioBitrateSlider.addTarget(self, action: Selector("onSliderValueChanged:"), forControlEvents: .ValueChanged)
        effectSegmentControl.addTarget(self, action: Selector("onEffectValueChanged:"), forControlEvents: .ValueChanged)
        ...
        */
        ...
        navigationItem.rightBarButtonItems = [
            UIBarButtonItem(title: "Torch", style: .Plain, target: self, action: Selector("toggleTorch:")),
            UIBarButtonItem(title: "Camera", style: .Plain, target: self, action: Selector("rotateCamera:"))
        ]
